  ...
  for (auto myController : myControllers) {
    ...
    if (myController && myController->isConnected()
      ...
      if (roboLigado) {
        ...
        // Se X for presionado, liga arma traseira.
        if (botoesPressionados == 0x0001) {
          digitalWrite(PINO_ARMA3, LOW);
        }

        // Se TRIÂNGULO for presionado, desliga arma traseira.
        else if (botoesPressionados == 0x0008) {
          digitalWrite(PINO_ARMA3, HIGH);
        }
